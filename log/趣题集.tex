...
\begin{itemize}
\item{ 《最迷人的数学趣题：一位数学名家精彩的趣题珍集》彼得·温克勒 }
\item{ 《直觉泵和其他思考工具》丹尼尔·丹尼特 }
\item{ 《模型思维》斯科特·佩奇 }
\item{ 李永乐老师的数学教学视频 }
\end{itemize}
...
\begin{itemize}
\item{ 可以巧妙应用于生活和实际的趣题。 }
\item{ 能让人产生啊哈，原来如此的感觉。 }
\item{ 大自然的数学家：能够体现自然本身的数学属性，比如素数蝉，分形等。 }
\item{ 具有趣味性的，让人百思不得其解的悖论。 }
\item{ 解法或者证明方法非常巧妙和启发性。 }
\end{itemize}
...
\begin{center}
\input{images/趣题集/无中生有反证法/image1}
\end{center}
...
\begin{center}
\input{images/趣题集/无中生有反证法/image3}
\end{center}
